...
my $outputfile = "dim24.kdevice.xml";

my @channels = ('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x');
my @rgbchannels = ('abc', 'efg', 'ijk', 'mno', 'qrs', 'uvw');
...
<KonnektingDevice xmlns="http://konnekting.de/xml/KonnektingDevice/v0">
    <Device ManufacturerId="7337" DeviceId="99" Revision="0">
